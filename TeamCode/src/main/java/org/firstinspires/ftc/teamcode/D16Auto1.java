...
public class D16Auto1 extends RR10515Base
{
    ...
    public void runOpMode() {
        ...
        if (position.equals("CENTER")) removeCenter();
        else if(position.equals("LEFT")) removeLeft();
        else if(position.equals("RIGHT")) removeRight();
        else moveStraightEncoder(749,.3);
